...
import com.timecapsule.oauthservice.security.filter.JwtAuthenticationEntryPoint;
import com.timecapsule.oauthservice.security.filter.JwtAuthenticationFilter;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public void configure(WebSecurity web) { // 인증 예외 URL 설정
        web.ignoring()
                ...
                .antMatchers(HttpMethod.GET, "/api/login/oauth/**")
